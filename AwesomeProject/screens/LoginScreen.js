    ...
    <ScrollView style={styles.container}>
      <View>
        ...
        <View style={styles.formContainer}>
          ...
          <Text style={[styles.text, styles.link, styles.forgetText]}>
            Forget Password ?
          </Text>
          <TouchableOpacity
            onPress={() => login(email, password)}
            style={[styles.submitContainer, styles.shadow, styles.f_c_c_c]}>
          ...
          <TouchableOpacity>
            <View style={styles.socialButton}>
              <Image
                ...
                source={require('../assets/logos/onusefb.png')}
              />
            </View>
          </TouchableOpacity>
          <TouchableOpacity>
            <View style={styles.socialButton}>
              <Image
                style={styles.socialLogo}
                source={require('../assets/logos/onusegoogle.png')}
                resizeMode="contain"
              />
            </View>
          </TouchableOpacity>
        </View>
        <View style={[styles.footerContainer, styles.f_r_c]}>
