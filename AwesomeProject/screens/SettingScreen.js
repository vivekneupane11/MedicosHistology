            ...
            <View style={styles.settingsContainer}>
                <View style={styles.settingsSection}>
                    <View style={styles.list}>
                        <Icon style={{flex:1.5}} name="user" size={24} color="#ABB4BD" />
                        <Text style={{ flex: 9 }}>Account</Text>
                        {/* <Icon name="sticky-note-o" size={24} color="#ABB4BD" /> */}
                    </View>
                    <View style={styles.list}>
                        <Icon style={{flex:1.5}} name="sticky-note-o" size={24} color="#ABB4BD" />
                        <Text style={{ flex: 9 }}>Push Notification</Text>
                        {/* <Icon name="sticky-note-o" size={24} color="#ABB4BD" /> */}
                    </View>
                    <View style={styles.list}>
                        <Icon style={{flex:1.5}} name="cog" size={24} color="#ABB4BD" />
                    ...
                    <View style={styles.endlist}>
                        <Icon style={{flex:1.5}} name="params" size={24} color="#ABB4BD" />
                ...
                <View style={styles.settingsSection}>
                    ...
                    <View style={styles.list}>
                        <Icon style={{flex:1.5}} name="search" size={24} color="#ABB4BD" />
                        <Text style={{ flex: 9 }}>Invite More Friends</Text>
                        {/* <Icon name="sticky-note-o" size={24} color="#ABB4BD" /> */}
                    </View>
                    <View style={styles.list}>
                        <Icon style={{flex:1.5}} name="home-outline" size={24} color="#ABB4BD" />
                        <Text style={{ flex: 9 }}>About Us</Text>
                        <Icon name="sticky-note-o" size={24} color="#ABB4BD" />
                    </View>
                    <View style={styles.endlist}>
                        <Icon style={{flex:1.5}} name="bookmark-empty" size={24} color="#ABB4BD" />
                ...
                <View style={styles.settingsSection}>
                    <View style={styles.endlist}>
                        ...
                        {/* <Icon name="cog" size={24} color="#ABB4BD" /> */}
                    </View>
                </View>
                {/* Third Section */}
            </View>
